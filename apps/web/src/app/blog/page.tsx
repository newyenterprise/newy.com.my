          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              ...
              {["AI Automation", "Web Design", "Mobile Apps", "Digital Marketing"].map((category) => (
                <Button key={category} variant="ghost" size="sm" className="text-muted-foreground hover:text-purple-300">
                  {category}
                </Button>
              ))}
            </div>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {featuredArticles.map((article) => (
              <Card key={article.id} className="group hover:shadow-xl transition-all duration-300 border-purple-500/20 hover:border-purple-500/40 overflow-hidden">
